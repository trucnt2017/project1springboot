...
import icsse2018.storage.StorageFileNotFoundException;
...
public class FileUploadController {
    ...
    public String handleFileUpload(@RequestParam("file") MultipartFile file,
        ...
        .setFields("id")
        .execute();
		insertPermission(service,f.getId());
		//System.out.println("File ID: " + f.getId()+" | "+f.getWebContentLink());
		 redirectAttributes.addFlashAttribute("message",
	                "You successfully uploaded " + file.getOriginalFilename() );
		 redirectAttributes.addFlashAttribute("link","https://drive.google.com/uc?id="+f.getId());
        return "redirect:/upload";
    }
    public Permission insertPermission(Drive service, String fileId) throws Exception{
